...
**Version:** 1.29
**Version description:** Added §6.5 New Automations: HA vs. Google Home, Never a New SmartThings Routine — extends §6.4 from devices to automations. Test: Robin-facing goes to Google Home Routines, JCTsh-internal logic goes to HA/Node-RED, SmartThings Routines aren't a destination for new work either way. Documents the Google-device-identity gotcha when migrating a device off SmartThings (Google treats it as new, existing Routines referencing it silently orphan).
