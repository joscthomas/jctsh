...
**Version:** 1.24
**Version description:** Added §2.14 point 12 — the three-signal hardware framework (Intent, Power Connected, Power Switch) every field-and-later-upload device needs, independently, never conflated. A real audit found neither existing field device has all three: hiking-monitor is missing a genuine Power Switch (CARD-0181), air-quality-monitor is missing Intent entirely (CARD-0218). Point 11 (added same day) is the firmware-behavior consequence of getting this framework right.
