...
├── tos/                           Team Operating System — kanban board, process definition,
│                                       and auto-PR intake/landing tooling (see tos/README.md)
...
| Directory | Contents |
|---|---|
| `core/data-pipeline/` | Environmental Data Apps Script + Node-RED flow — GPS/sensor correlation pipeline shared across hiking-monitor, air-quality-monitor, front-porch-temp-sensor, and back-patio-temp-sensor — see [core/data-pipeline/README.md](core/data-pipeline/README.md) |
...
| `core/docker/` | Docker daemon config (DNS pinning, journald log driver, containerd data-root) for hosts running containers — see [core/docker/README.md](core/docker/README.md) |
...
| `kanban-board.md` | Kanban board — all planned and in-progress work | `tos/` |
