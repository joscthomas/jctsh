...
file. `README.md` in this directory is the permanent reference (what this directory is
for); this file is history/rationale, kept separate per `JCTsh-Operating-System.md`'s
