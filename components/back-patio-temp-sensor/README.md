...
| Component | Details |
|---|---|
| Microcontroller | ESP32 DevKitC-32, 38-pin, CP2102, USB-C (same board batch as air-quality-monitor's — see `ESP32-project-pins.md` for that batch's known pin 18 GND anomaly, unused by this build) |
