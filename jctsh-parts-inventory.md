...
| LiPo Battery 503035 | 3.7V 500mAh 503035, JST PH2.0mm 2-pin connector. https://www.amazon.com/dp/B07S84SBV3 — confirm polarity before use. | ? ⚠️ | Unknown | Added 2026-09-25 from Joseph: these are the existing 500mAh cells he'd planned to swap out of hiking-monitor and air-quality-monitor for the 503450 1000mAh cells (row below) and return to stock. Quantity and current location not yet given. Note the hiking-monitor and AQM docs still name the EEMB 603449 1100mAh as their cell, not this one. |
...
| 2026-09-25 | Stock | LiPo Battery 3.7V 500mAh 503035 added to Power Components (ASIN B07S84SBV3) — the existing cells behind the earlier 503450 entry, previously missing from the inventory. Qty and location left unknown pending Joseph. |
