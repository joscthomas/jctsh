...
| ops cluster | `core/maintenance`, `core/docker`, `hosts/m8`, `hosts/pi1` | No | — |
| outdoor/backyard sensors cluster | `remote-temp-sensor-01`, `van-sensors`, `weather-station`, `bedside-clock` | No | — |
| salt-sensor | `salt-sensor` | No | — |
| p-w-firefly | `p-w-firefly` | No | — |
| jctsh-menu | `jctsh-menu` | No | — |
| front-porch-temp-sensor | `front-porch-temp-sensor` | No | — |
