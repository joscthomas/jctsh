...
**Version:** 1.20
**Version description:** CARD-0303 — moved "Concurrent Sessions" here from root `CLAUDE.md` (pure process/policy, previously homeless); added two more principles found live during this same reconciliation — "merge, don't just delete" as a corollary to single-source-of-truth, and "superseding stale content: mark and strike through, don't silently delete" (from `JCTsh-Build-Standards.md` §5's own internal contradiction with §6.4, found and fixed the same pass).
