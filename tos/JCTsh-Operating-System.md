...
**Related:** CARD-0251 (origin, both marker flavors), CARD-0258 (found and fixed the resolution gap this protocol formalizes), CARD-0224/CARD-0276 (the status-vs-marker correction), `core/logging/log_server.py` (`_parse_kanban_board()`, the badge-rendering parser both flavors share).
