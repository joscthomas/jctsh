...
- **Still open:** (c) whether the Google Home critical routine fired when the switch turned on at 17:04:57 -- only Joseph can say. The card closes when he answers (fired / did not fire and why).
