...
**Status:** Build — retry-before-alert mitigation confirmed live (Watch for resolved, see below); GPS Track stall's root cause is the only thing still open
