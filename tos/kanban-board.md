...
- **Still open:** (c) whether the Google Home critical routine actually fired when the switch turned on at 17:04:57 -- only Joseph can say; (e) deploy the flow, then confirm live that a critical reading leaves the switch on.
