...
**Done when:** the pipeline mechanics above are fully verified (real end-to-end run against the 2026-09-19 hike, correct Sheet/page output). **Staying in Build, not Done, on Joseph's own instruction** -- he wants to check the results himself (the actual scat.html page, the specific photos) before this closes, same discipline as the "Not independently verifiable by this session" note above.
